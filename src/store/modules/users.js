...
export default {
  ...
  actions: {
    ...
    fetchUser: ({dispatch}, {id}) => dispatch('fetchItem', {resource: 'users', id, emoji: 'S'}, {root: true}),
    fetchUsers: ({dispatch}, {ids}) => dispatch('fetchItems', {resource: 'users', ids, emoji: 'forums'}, {root: true})
